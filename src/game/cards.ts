...
export const MAGE_CARDS: Card[] = [
  ...
  { 
    ...
    opcode: 'SELF_GUARD', 
    power: 9, 
    desc: 'Conjure fire shield for 9 defense',
    type: 'defense',
    class: 'Mage'
  },
  { 
...
export const WARRIOR_ADVANCED_CARDS: Card[] = [
  ...
  { 
    ...
    opcode: 'GUARD', 
    power: 6, 
    desc: '🛡️ Grant 6 Shield to ALL allies',
    type: 'defense',
    class: 'Warrior'
  },
  { 
